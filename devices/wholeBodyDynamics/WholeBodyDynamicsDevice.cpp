...
bool WholeBodyDynamicsDevice::setupCalibrationWithVerticalForcesOnTheFeetAndJetsONiRonCubMk1_1(const int32_t nrOfSamples)
{
    // Let's configure the external forces that then are assume to be active on the robot while calibration on two links (assumed to be symmetric)
    ...
    // Check if the iRonCub-Mk1_1 jets frames exist
    ...
    {
        yError() << "wholeBodyDynamics : setupCalibrationWithVerticalForcesOnTheFeetAndJetsONiRonCubMk1_1 impossible to find frame " << leftArmJetFrame << ", Are you using iRonCub-Mk1_1?";
        return false;
    }
    ...
    {
        yError() << "wholeBodyDynamics : setupCalibrationWithVerticalForcesOnTheFeetAndJetsONiRonCubMk1_1 impossible to find frame " << RightArmJetFrame << ", Are you using iRonCub-Mk1_1?";
        return false;
    }
    ...
    {
        yError() << "wholeBodyDynamics : setupCalibrationWithVerticalForcesOnTheFeetAndJetsONiRonCubMk1_1 impossible to find frame " << leftBackJetFrame << ", Are you using iRonCub-Mk1_1?";
        return false;
    }
    ...
    {
        yError() << "wholeBodyDynamics : setupCalibrationWithVerticalForcesOnTheFeetAndJetsONiRonCubMk1_1 impossible to find frame " << RightBackJetFrame << ", Are you using iRonCub-Mk1_1?";
        return false;
    }
    ...
    {
        yError() << "wholeBodyDynamics : setupCalibrationWithVerticalForcesOnTheFeetAndJetsONiRonCubMk1_1 impossible to find frame " << LeftSoleFrame;
        return false;
    }
    ...
    {
        yError() << "wholeBodyDynamics : setupCalibrationWithVerticalForcesOnTheFeetAndJetsONiRonCubMk1_1 impossible to find frame " << RightSoleFrame;
        return false;
    }
    ...
    iDynTree::Force jetArmForce = iDynTree::Force(0,0,p160IdleThrustN);
    ...
    if( !ok )
    {
        yError() << "wholeBodyDynamics : setupCalibrationWithVerticalForcesOnTheFeetAndJetsONiRonCubMk1_1 error";
        return false;
    }
...
bool WholeBodyDynamicsDevice::calibStandingWithJetsiRonCubMk1_1(const std::string& calib_code, const int32_t nr_of_samples)
{
    std::lock_guard<std::mutex> guard(this->deviceMutex);

    yWarning() << "wholeBodyDynamics : calibStandingWithJetsiRonCubMk1_1 ignoring calib_code " << calib_code;

    bool ok = this->setupCalibrationWithVerticalForcesOnTheFeetAndJetsONiRonCubMk1_1(nr_of_samples);
